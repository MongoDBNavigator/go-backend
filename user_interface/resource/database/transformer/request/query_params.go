...
func ExtractFilter(request *restful.Request) (map[string]interface{}, error) {
	...
	if err := json.Unmarshal([]byte(request.QueryParameter("filter")), &filters); err != nil {
		log.Println(err)
...
func parseFilter(data string) (map[string]interface{}, error) {
